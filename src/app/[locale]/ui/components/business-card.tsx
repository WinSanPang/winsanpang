            ...
            {contactDetails.map(({ icon, link, text }) => (
              <li key={icon}>
                <Link
                  ...
                  className="text-white text-sm md:text-base flex justify-center md:justify-normal py-2 hover:text-sky-500 hover:underline transition-all duration-500 animate-float"
                >
                  <Image
                    src={`/icons/${icon}.svg`}
